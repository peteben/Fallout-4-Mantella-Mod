...
string property HTTP_ROUTE_STT = "stt" autoReadOnly
...
string property PREFIX = "mantella_" autoReadOnly
...
string property KEY_ACTOR_PC_VOICEPLAYERINPUT = "mantella_pc_voiceplayerinput" autoReadOnly
string property KEY_ACTOR_PC_VOICEMODEL = "mantella_pc_voicemodel" autoReadOnly
...
string property KEY_ACTOR_VOICEFILE= "mantella_actor_voice_file" autoReadOnly
...
string property KEY_INPUT_NAMESINCONVERSATION = "mantella_names_in_conversation" autoReadOnly
...
;in-game
string property ACTION_NPC_OFFENDED = "mantella_npc_offended" autoReadOnly
string property ACTION_NPC_FORGIVEN = "mantella_npc_forgiven" autoReadOnly
string property ACTION_NPC_FOLLOW = "mantella_npc_follow" autoReadOnly
string property ACTION_NPC_UNFOLLOW = "mantella_npc_unfollow" autoReadOnly
...
string property ACTION_NPC_BRAWL = "mantella_npc_brawl" autoReadOnly
string property ACTION_NPC_MOVETO = "mantella_npc_moveto" autoReadOnly
string property ACTION_NPC_TRAVELTO = "mantella_npc_travelto" autoReadOnly
string property ACTION_NPC_LEADTO = "mantella_npc_leadto" autoReadOnly
string property ACTION_NPC_CANCELTRAVEL = "mantella_npc_canceltravel" autoReadOnly
string property ACTION_NPC_TELEPORT = "mantella_npc_teleport" autoReadOnly
string property ACTION_NPC_WAIT = "mantella_npc_wait" autoReadOnly
string property ACTION_NPC_LOOT = "mantella_npc_loot" autoReadOnly
string property ACTION_NPC_COLLECTINGREDIENTS = "mantella_npc_collectingredients" autoReadOnly
string property ACTION_NPC_CASTSPELL = "mantella_npc_castspell" autoReadOnly
string property ACTION_NPC_GIVEDIRECTIONS = "mantella_npc_givedirections" autoReadOnly
string property ACTION_NPC_ADDTOCONVERSATION = "mantella_npc_addtoconversation" autoReadOnly
string property ACTION_NPC_SHARECONVERSATION = "mantella_npc_shareconversation" autoReadOnly
string property ACTION_NPC_REPORTCRIME = "mantella_npc_reportcrime" autoReadOnly
string property ACTION_NPC_ABSOLVECRIME = "mantella_npc_absolvecrime" autoReadOnly
string property ACTION_NPC_EMOTE = "mantella_npc_emote" autoReadOnly
string property ACTION_NPC_FLEE = "mantella_npc_flee" autoReadOnly
;OLD F4
string property ACTION_NPC_MOVETO_NPC = "mantella_move_character_near_npc" autoReadOnly
string property ACTION_MULTI_MOVETO_NPC = "mantella_move_characters_near_npc" autoReadOnly
string property ACTION_MAKE_NPC_WAIT = "mantella_make_npc_wait" autoReadOnly
string property ACTION_MULTI_MAKE_NPC_WAIT = "mantella_multi_make_npc_wait" autoReadOnly
string property ACTION_NPC_ATTACK_OTHER_NPC = "mantella_npc_attack_other_npc" autoReadOnly
string property ACTION_MULTI_NPC_ATTACK_OTHER_NPC = "mantella_multi_npc_attack_other_npc" autoReadOnly
string property ACTION_NPC_LOOT_ITEMS = "mantella_npc_loot_items" autoReadOnly
string property ACTION_MULTI_NPC_LOOT_ITEMS ="mantella_multi_npc_loot_items" autoReadOnly
string property ACTION_NPC_HEAL_PLAYER = "mantella_heal_me" autoReadOnly
string property ACTION_NPC_USE_ITEM = "mantella_npc_use_item_on_target" autoReadOnly
string property ACTION_MULTI_NPC_USE_ITEM = "mantella_multi_use_item_on_target" autoReadOnly
...
string property ACTION_ARG_SOURCE = "source" autoReadOnly
string property ACTION_ARG_TARGET = "target" autoReadOnly
...
string property KEY_CONTEXT_CUSTOMVALUES_PLAYERHEALTH = "mantella_player_health_percent" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_PLAYERRAD = "mantella_player_rad_percent" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_VISION_READY = "mantella_vision_ready" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_VISION_RES = "mantella_vision_resolution" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_VISION_RESIZE = "mantella_vision_resize" autoReadOnly
...
string property KEY_ACTOR_CUSTOMVALUES_POSX = "mantella_actor_pos_x" autoReadOnly
string property KEY_ACTOR_CUSTOMVALUES_POSY = "mantella_actor_pos_y" autoReadOnly
...
string property KEY_CONTEXT_CUSTOMVALUES_ACTORS_AT_LEAST_ONE_FOLLOWER = "mantella_actors_one_follower" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_ACTORS_AT_LEAST_ONE_SETTLER = "mantella_actors_one_settler" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_ACTORS_AT_LEAST_ONE_GENERIC = "mantella_actors_one_generic" autoReadOnly
...
string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_ENABLED = "mantella_function_enabled" autoReadOnly

string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_NPCDISPLAYNAMES = "mantella_function_npc_display_names" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_NPCDISTANCES = "mantella_function_npc_distances" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_NPCIDS = "mantella_function_npc_ids" autoReadOnly
;string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_STIMPACKCOUNT = "mantella_function_npc_stimpackcount" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_STIMPAK_ACTOR_LIST = "mantella_function_npc_stimpak_list" autoReadOnly
string property KEY_CONTEXT_CUSTOMVALUES_FUNCTIONS_RADAWAY_ACTOR_LIST = "mantella_function_npc_radaway_list" autoReadOnly

;;;;;;;;;;; INPUT ('Mantella Mod <- Mantella Software') ;;;;;;;;;;;;;

string property FUNCTION_DATA_TARGET_IDS = "mantella_function_data_target_ids" autoReadOnly
string property FUNCTION_DATA_TARGET_NAMES = "mantella_function_data_target_names" autoReadOnly
string property FUNCTION_DATA_SOURCE_IDS = "mantella_function_data_source_ids"autoReadOnly
string property FUNCTION_DATA_MODES = "mantella_function_data_modes" autoReadOnly